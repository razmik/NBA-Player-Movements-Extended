...
class Event:
    ...
    def __init__(self, event):
        ...
        # Example: 101108: ['Chris Paul', '3', 'F']
        self.player_ids_dict = dict(zip(player_ids, values))

        moments = event['moments']
        self.moments = [Moment(moment, self.player_ids_dict) for moment in moments]

    def update_radius(self, i, player_circles, ball_circle, annotations, clock_info, skip):
        ...
        if i % skip == 0:
            plt.savefig('temp/{}.jpeg'.format(i))

        return player_circles, ball_circle

    def show_updated(self, skip=5):
        ...
        anim = animation.FuncAnimation(
                         ...
                         fargs=(player_circles, ball_circle, annotations, clock_info, skip),
